...
- [x] 33-02-PLAN.md — login page/form/action の next パラメータ対応（BUG-02 login-side）
- [x] 33-03-PLAN.md — RPC 関数 schema.sql 追加 + updateCommitSlotsAction RPC 化（DB-01）
...
- [x] 34-03-PLAN.md — commitUtils achievementRateエクスポート + sortMembersForCommitViewを3グループ・5キーソートに更新
- [x] 34-04-PLAN.md — Footer.tsx（3ステートServer Component）+ HeaderNav.tsx（usePathname Client Component）新規作成

**Wave 3** *(Wave 2完了後)*

- [x] 34-05-PLAN.md — layout.tsxにFooterを配線、Header.tsxにHeaderNavを配線・フルスイート検証
...
- [x] 35-01-PLAN.md — TEAM-03 テスト更新 + page.tsx private チームタブ有効化（TEAM-01）
- [x] 35-02-PLAN.md — layout.tsx に GoogleAnalytics 追加（ANLT-01/02）
...
Plans:
**Wave 1**
- [ ] 36-01-PLAN.md — config 375px viewport + 27-handle.spec.ts + 28-commit-flow.spec.ts（QA-02/QA-03 自動レイヤー）
...
| 36. QA・UAT・検証ギャップ解消 | v1.8 | 0/4 | In progress | - |
